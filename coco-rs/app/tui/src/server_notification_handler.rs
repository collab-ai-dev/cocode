...
fn core_event_variant(notif: &coco_event_types::ServerNotification) -> &'static str {
    ...
    match notif {
        ...
        N::MoaReferenceStarted(_) => "MoaReferenceStarted",
        N::MoaReferenceCompleted(_) => "MoaReferenceCompleted",
        N::MoaAggregating(_) => "MoaAggregating",
...
fn tui_event_variant(t: &coco_event_types::TuiOnlyEvent) -> &'static str {
    ...
    match t {
        ...
        E::ProviderStatusesRefreshed { .. } => "ProviderStatusesRefreshed",
        E::ModelCatalogRefreshed { .. } => "ModelCatalogRefreshed",
        ...
        E::CronScriptResult { .. } => "CronScriptResult",
        ...
        E::OpenGoalStatus { .. } => "OpenGoalStatus",
        E::OpenContextUsage { .. } => "OpenContextUsage",
        E::RewindPreClearSnapshot { .. } => "RewindPreClearSnapshot",
        ...
        E::OpenLoginPicker { .. } => "OpenLoginPicker",
