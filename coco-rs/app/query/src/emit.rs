...
fn tui_kind(evt: &TuiOnlyEvent) -> &'static str {
    match evt {
        ...
        TuiOnlyEvent::AutoModeDenied { .. } => "auto_mode_denied",
        ...
        TuiOnlyEvent::ProviderStatusesRefreshed { .. } => "provider_statuses_refreshed",
        TuiOnlyEvent::ModelCatalogRefreshed { .. } => "model_catalog_refreshed",
        ...
        TuiOnlyEvent::OpenLoginPicker { .. } => "open_login_picker",
