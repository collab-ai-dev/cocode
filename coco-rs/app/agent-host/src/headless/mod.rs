...
use support::{
    acquire_headless_local_session_lease, append_headless_goal_status, append_headless_slash_text,
    build_tool_filter, headless_goal_snapshot, headless_local_goal_text_outcome,
    headless_text_outcome, load_headless_prior_messages, parse_headless_goal_slash,
