...
use coco_app_server::{AppSessionDataError, LiveSessionDataMessage, LiveSessionDataSnapshot};
use coco_types::SessionId;

pub(crate) type PersistedSessionDataError = AppSessionDataError;

pub(crate) fn live_session_data_snapshot(
    (summary, history): (
...
) -> Result<coco_types::SessionSummary, String> {
