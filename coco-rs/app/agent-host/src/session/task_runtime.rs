...
pub struct TaskRuntime {
    pub(in crate::session::task_runtime) manager: Arc<TaskManager>,
    pub(in crate::session::task_runtime) disk: Arc<DiskOutputs>,
...
pub(in crate::session::task_runtime) fn boxed_msg(
