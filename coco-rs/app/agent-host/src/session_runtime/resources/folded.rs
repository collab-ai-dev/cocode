...
#[derive(Clone)]
pub(in crate::session_runtime) struct SessionExecutionResources {
    pub(in crate::session_runtime) tools: Arc<ToolRegistry>,
    pub(in crate::session_runtime) model_runtimes: Arc<coco_inference::ModelRuntimeRegistry>,
}
...
impl SessionExecutionResources {
    ...
    pub(in crate::session_runtime) fn tools(&self) -> &Arc<ToolRegistry> {
        &self.tools
    }

    pub(in crate::session_runtime) fn model_runtimes(
        &self,
...
pub(in crate::session_runtime) struct SessionConfigResources {
    pub(in crate::session_runtime) config_home: PathBuf,
    pub(in crate::session_runtime) runtime_config: Arc<RuntimeConfig>,
    pub(in crate::session_runtime) config_reloader: Option<coco_config_reload::RuntimeReloader>,
}
...
impl SessionConfigResources {
    ...
    pub(in crate::session_runtime) fn config_home(&self) -> &PathBuf {
        &self.config_home
    }

    pub(in crate::session_runtime) fn runtime_config(&self) -> &Arc<RuntimeConfig> {
        &self.runtime_config
    }

    pub(in crate::session_runtime) fn runtime_publisher(
        &self,
    ...
    pub(in crate::session_runtime) fn subscribe_config_changes(
        &self,
    ...
    pub(in crate::session_runtime) fn subscribe_config_reload_errors(
        &self,
...
#[derive(Clone)]
pub(in crate::session_runtime) struct SessionCatalogResources {
    pub(in crate::session_runtime) command_registry: Arc<RwLock<Arc<CommandRegistry>>>,
    pub(in crate::session_runtime) skill_manager: Arc<coco_skills::SkillManager>,
}
...
impl SessionCatalogResources {
    ...
    pub(in crate::session_runtime) fn command_registry(
        &self,
    ) -> &Arc<RwLock<Arc<CommandRegistry>>> {
        &self.command_registry
    }

    pub(in crate::session_runtime) fn skill_manager(&self) -> &Arc<coco_skills::SkillManager> {
        &self.skill_manager
    }
}
...
#[derive(Clone)]
pub(in crate::session_runtime) struct SessionTurnResources {
    pub(in crate::session_runtime) schedule_store: coco_tool_runtime::ScheduleStoreRef,
    pub(in crate::session_runtime) side_query: coco_tool_runtime::SideQueryHandle,
    pub(in crate::session_runtime) usage_accounting: coco_query::usage_accounting::UsageAccounting,
    pub(in crate::session_runtime) mailbox: MailboxHandleRef,
    pub(in crate::session_runtime) permission_bridge: Option<ToolPermissionBridgeRef>,
}
...
impl SessionTurnResources {
    ...
    pub(in crate::session_runtime) fn schedule_store(&self) -> coco_tool_runtime::ScheduleStoreRef {
        self.schedule_store.clone()
    }

    pub(in crate::session_runtime) fn side_query(&self) -> coco_tool_runtime::SideQueryHandle {
        self.side_query.clone()
    }

    pub(in crate::session_runtime) fn usage_accounting(
        &self,
    ) -> coco_query::usage_accounting::UsageAccounting {
        self.usage_accounting.clone()
    }

    pub(in crate::session_runtime) fn mailbox(&self) -> MailboxHandleRef {
        self.mailbox.clone()
    }

    pub(in crate::session_runtime) fn permission_bridge(&self) -> Option<ToolPermissionBridgeRef> {
...
#[derive(Clone)]
pub(in crate::session_runtime) struct SessionCommandResources {
    pub(in crate::session_runtime) attachment_tx:
        tokio::sync::mpsc::UnboundedSender<coco_messages::AttachmentMessage>,
    pub(in crate::session_runtime) attachment_rx: SessionAttachmentRx,
    pub(in crate::session_runtime) command_queue: CommandQueue,
}
...
impl SessionCommandResources {
    ...
    pub(in crate::session_runtime) fn attachment_emitter(
        &self,
    ) -> coco_messages::AttachmentEmitter {
        coco_messages::AttachmentEmitter::new(self.attachment_tx.clone())
    }

    pub(in crate::session_runtime) fn attachment_channel(
        &self,
    ) -> (
        tokio::sync::mpsc::UnboundedSender<coco_messages::AttachmentMessage>,
        SessionAttachmentRx,
    ...
    pub(in crate::session_runtime) fn command_queue(&self) -> &CommandQueue {
        &self.command_queue
    }
}
