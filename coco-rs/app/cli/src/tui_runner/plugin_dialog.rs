...
pub(super) async fn build_plugin_dialog_payload(
    session: &crate::session_runtime::SessionHandle,
...
pub(super) fn build_plugin_dialog_skill_rows(
...
pub(super) fn plugin_dialog_skill_source(
    source: &coco_skills::SkillSource,
) -> coco_types::SkillsDialogSource {
    match source {
...
pub(super) fn plugin_dialog_skill_source_sort_key(
...
pub(super) fn build_system_message_from_push_kind(
