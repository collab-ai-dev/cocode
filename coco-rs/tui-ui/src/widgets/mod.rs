...
pub use textarea::ElementError;
pub use textarea::EolBehavior;
pub use textarea::TextArea;
pub use textarea_elements::ElementDisplay;
pub use textarea_elements::ElementId;
pub use textarea_elements::ElementKind;
pub use textarea_elements::ProjectedTextElement;
pub use textarea_elements::TextAreaSnapshot;
pub use textarea_elements::TextElement;
pub use textarea_elements::TextProjection;
pub use textarea_layout::wrap_ranges;
pub use textarea_layout::wrap_ranges_with_elements;
