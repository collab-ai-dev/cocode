...
pub use predicates::count_tool_calls_in;
pub use predicates::count_tool_calls_in_last_assistant_turn;
pub use predicates::messages_after_compact_boundary;
pub use predicates::messages_since_last_user_prompt;
pub use predicates::skill_invoked_in;
...
pub use token_estimation::estimate_json_tokens;
