//! `/run-skill-generator` — run the skill-generator workflow to create or refine a SKILL.md.

const TEMPLATE: &str = r#"Run the skill-generator workflow to create or refine a SKILL.md.
...
3. Draft a SKILL.md at `{{CONFIG_DIR_NAME}}/skills/<skill-name>/SKILL.md` with proper frontmatter (name, description, when_to_use, allowed-tools, argument-hint, paths if applicable).
