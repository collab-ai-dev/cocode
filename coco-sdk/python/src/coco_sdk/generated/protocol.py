...
class ServerNotificationGoalActiveChanged(BaseModel):
    model_config = {"populate_by_name": True}
    method: Literal['goal/activeChanged'] = Field(default='goal/activeChanged', alias='method')
...
class TuiOnlyEventRewindPreClearSnapshot(BaseModel):
    model_config = {"populate_by_name": True}
    type_: Literal['rewind_pre_clear_snapshot'] = Field(default='rewind_pre_clear_snapshot', alias='type')
