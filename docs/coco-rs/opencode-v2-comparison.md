...
- `coco-rs: docs/coco-rs/session-storage-backend-design.md`
...
- `coco-rs: docs/coco-rs/prompt-cache-design.md`
...
- `coco-rs: docs/coco-rs/event-system-design.md`
- `coco-rs: docs/coco-rs/engine-tui-unified-transcript-plan.md`
...
- `coco-rs: docs/coco-rs/tool-schema-validated-newtype-plan.md`
- `coco-rs: docs/coco-rs/tool-result-budget-plan.md`
...
- `coco-rs: docs/coco-rs/permission-sandbox-hardening.md`
...
- `coco-rs: docs/coco-rs/multi-provider-plan.md`
...
- `coco-rs: docs/coco-rs/ui/tui-v2-design.md`
