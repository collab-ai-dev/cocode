...
this repo) and the in-repo analysis doc `docs/internal/jcode/09-…md`; treat them as
...
> app/cli — the docs/internal CLAUDE.md map is stale). `services/inference` already
...
> the crate to the docs/internal CLAUDE.md L2 layer table + Crate Count table.
