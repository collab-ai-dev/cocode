...
- TS taxonomy and IPC details: `docs/internal/subagent-refactor-plan.md` (Phase 0–10), `agent-loop-refactor-plan.md` (Phases 1–9, invariants I1–I14). Both predate this doc; refer to them for the scaffolding rationale and TS line citations, but treat the *layering decisions* in this doc as authoritative.
