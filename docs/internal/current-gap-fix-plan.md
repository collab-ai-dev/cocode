...
- `docs/internal/audit-gaps.md`
- `docs/internal/parity-skills-commands-plugins.md`
...
- `docs/internal/tool-result-budget-plan.md` assigns the real Level 1 and Level
...
- `docs/internal/parity-skills-commands-plugins.md` says the builder registry
