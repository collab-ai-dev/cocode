...
| 来源 | 路径 | 用途 |
|------|------|------|
| 当前 docs | `docs/internal/agent-loop-refactor-plan.md` | 已提出 `AgentRuntime`、`SkillRuntime`、`ToolCallRunner` 等大方向 |
| 当前 docs | `docs/internal/crate-coco-tools.md` | 描述 `AgentTool` 应具备的动态 agent 列表、fork、background、tool filtering |
| 当前 docs | `docs/internal/crate-coco-types.md` | 记录 `AgentDefinition`、`SubagentType`、`AgentIsolation` 等类型目标 |
| 当前 docs | `docs/internal/crate-coco-commands.md` | 记录 slash command registry 和 `/agents` 命令方向 |
...
`docs/internal/agent-loop-refactor-plan.md` 已经提出一个正确的大方向：
...
`docs/internal/crate-coco-tools.md` 描述了理想 `AgentTool`：
...
`docs/internal/crate-coco-commands.md` 和 `common/types/src/command.rs` 已有 slash command 的关键类型基础：
